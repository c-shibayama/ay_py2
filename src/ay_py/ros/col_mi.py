...
class TStateValidityCheckerMI(TROSUtil):
  ...
  def __init__(self):
    ...
    self.c= self.TConfig()
    self.planning_scene_req= ay_util_msgs.srv.SetPlanningSceneDiffRequest()
  ...
  def Init(self, robot):
    ...
    ra(self.AddSrvP('check_state_validity_client', '/state_validity_checker/get_state_validity',
                    ay_util_msgs.srv.GetStateValidity, persistent=False, time_out=3.0))
    ra(self.AddSrvP('check_trajectory_validity_client', '/state_validity_checker/get_trajectory_validity',
                    ay_util_msgs.srv.GetTrajectoryValidity, persistent=False, time_out=3.0))
    ra(self.AddSrvP('get_allowed_collision_matrix_client', '/state_validity_checker/get_allowed_collision_matrix',
                    ay_util_msgs.srv.GetAllowedCollisionMatrix, persistent=False, time_out=3.0))
  ...
  def IsValidState(self, joint_positions, arm=0):
    req= ay_util_msgs.srv.GetStateValidityRequest()
  ...
  def IsValidTrajectory(self, joint_traj):
    ...
    req= ay_util_msgs.srv.GetTrajectoryValidityRequest()
